...
Thí nghiệm có kiểm soát trên KnowAir dùng 184 trạm, lịch sử 72 giờ, chân trời 72 giờ, chia thời gian 50/25/25 và ba hạt giống ngẫu nhiên. Trong thiết lập chẩn đoán chính, \modelname{}, đối chứng trực tiếp và mã công khai của AirDDE đều nhận khí tượng đã quan trắc trong 72 giờ đích; các biến thể chỉ dùng lịch sử được đánh giá riêng. Trên tập xác thực, \modelname{} đạt MAE $16.7630\pm0.0252$, thấp hơn mô hình dự báo trực tiếp gần bằng số tham số ở mức $18.8620\pm0.0457$. Trên tập kiểm tra, ba mô hình đơn đạt $16.1266\pm0.0348$, thấp hơn 4,7\% so với điểm MAE $16.92$ do AirDDE công bố dưới cùng tập thông tin và giao thức KnowAir cốt lõi; vì AirDDE không phát hành dự báo hay thống kê nhiều hạt giống, đây là so sánh điểm chứ không phải kiểm định ghép cặp. Trung bình đều ba mô hình \modelname{} đạt MAE/RMSE/sMAPE là $15.8205/24.3253/0.3721$. Trên Beijing Multi-Site độc lập gồm 12 trạm, \modelname{} giảm điểm ước lượng MAE kiểm tra từ $32.522$ xuống $30.873$ và sMAPE từ $0.546$ xuống $0.477$, dù RMSE tăng từ $51.196$ lên $52.079$. Khoảng tin cậy theo khối thời gian của chênh lệch MAE Beijing còn cắt 0, cho thấy lợi ích ngoài mẫu cần được kiểm chứng tiếp trên các mạng trạm khác.
\end{abstract}
...
Mô tả trên giấy và mã công khai của AirDDE không nhất quán về tập thông tin. Phương trình bài toán của AirDDE chỉ ghi nồng độ và yếu tố phụ trợ đến thời điểm hiện tại, $\widehat{X}_{T+1:T+H}=F(X_{1:T},M_{1:T};\Theta)$, và phần phương pháp nhiều lần gọi các yếu tố này là lịch sử \citep{wu2026airdde}. Tuy nhiên, kiểm toán mã công khai cho thấy bộ nạp dữ liệu tạo cửa sổ đích gồm cả nhãn và khí tượng, sau đó tách các kênh khí tượng tại $T+1{:}T+H$ thành \texttt{y\_cov}; mô hình dùng tensor này trong hạng nguồn/mất mát và ở mỗi bước giải mã. Vì vậy, giao thức thực thi của AirDDE điều kiện hóa trên khí tượng đích đã quan trắc, giống tập thông tin chính của chúng tôi. Hai cách cài đặt chỉ khác biểu diễn hướng gió: AirDDE chuẩn hóa góc theo độ, còn chúng tôi dùng sin/cos để tôn trọng tính tuần hoàn. Đây là khác biệt tiền xử lý, không phải lợi thế về thông tin sẵn có.
...
\begin{table}[t]
  ...
  \scriptsize
  \begin{tabularx}{\textwidth}{@{}p{1.45cm}p{1.8cm}p{2.1cm}Xp{2cm}@{}}
    \toprule
    Phương pháp & Dạng tiến hóa & Quan hệ không gian & Phân rã động lực & Khí tượng trong công thức dự báo \\
    \midrule
    PM2.5-GNN & Rời rạc, dựa trên bộ mã hóa & Đồ thị có tri thức miền & Không tách vận chuyển và nguồn/mất mát & Theo giao thức bài gốc \\
    AirFormer & Dự báo bằng bộ biến đổi & Chú ý không gian dạng bia tiêu & Không tách theo quá trình vật lý & Theo giao thức bài gốc \\
    AirPhyNet & Liên tục & Đồ thị trạm & Khuếch tán và bình lưu & Theo giao thức bài gốc \\
    Air-DualODE & Hai hệ liên tục & Đồ thị trạm & Nhánh vật lý và nhánh bù dữ liệu & Theo giao thức bài gốc \\
    AirDDE & Liên tục & Khoảng cách và trường gió & Khuếch tán, bình lưu và nguồn/mất mát & Công thức: lịch sử; mã: khí tượng đích đã quan trắc \\
    \modelname{} & Rời rạc, hồi quy & Đồ thị tám láng giềng theo gió & Vận chuyển tổng bằng không và nguồn/mất mát & Khí tượng đích đã quan trắc \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[t]
  \centering
  \caption{Giao thức KnowAir. Tập kiểm tra không được dùng để chọn siêu tham số.}
  \label{tab:protocol}
...
Trên Beijing, \modelname{} có MAE thấp hơn ở 64,9\% gốc dự báo và chênh lệch trung bình theo gốc là $1.6584\unitpm$, nhưng cận dưới vẫn nhỏ hơn 0 ở cả ba độ dài khối trong Bảng~\ref{tab:block-bootstrap}. Theo quy tắc diễn giải đã khóa trước khi mở tập kiểm tra, kết quả này được xem là một lần lặp lại có triển vọng, chưa phải bằng chứng kết luận về mọi giai đoạn thời gian.
...
Để đặt \modelname{} vào toàn cảnh đối chứng, Bảng~\ref{tab:test-reference} tổ chức lại toàn bộ 19 mô hình và AirDDE trong phần KnowAir của Bảng 2 công bố AirDDE \citep{wu2026airdde}. Phân loại trình bày gồm dự báo không gian--thời gian tổng quát, mô hình chuyên cho chất lượng không khí, động lực nơ-ron hoặc có định hướng vật lý, rồi AirDDE như mốc tham chiếu mạnh nhất. Các số này do AirDDE tổng hợp hoặc chạy lại, không phải kết quả tái lập của nghiên cứu này. Với các đối chứng không có mã đường dữ liệu được kiểm toán ở đây, chúng tôi không suy đoán việc chúng có đọc khí tượng đích hay không.

Kiểm toán mã cài đặt AirDDE xác nhận AirDDE và \modelname{} cùng dùng 24 bước lịch sử, 24 bước đích, phép chia 50/25/25, chuẩn hóa chỉ từ tập huấn luyện và khí tượng đã quan trắc trong toàn bộ giai đoạn đích. Do đó, so sánh trực tiếp hai dòng này là đồng nhất về tập thông tin và giao thức dữ liệu cốt lõi. Trung bình ba mô hình đơn \modelname{} đạt MAE $16.1266$, thấp hơn $0.7934\unitpm$ (4,7\%) so với điểm $16.92$ của AirDDE. Tuy nhiên, AirDDE chỉ công bố số tổng hợp và không cung cấp dự báo khớp theo từng cửa sổ hay phân phối nhiều hạt giống, nên chênh lệch này là so sánh điểm trên cùng giao thức, chưa phải bằng chứng ưu thế thống kê ghép cặp. Dòng ensemble được báo riêng và không dùng để tính mức giảm 4,7\%.

\clearpage
\begin{table}[H]
  \centering
  \caption{Các đối chứng KnowAir đã công bố và kết quả \modelname{}. AirDDE và \modelname{} dùng cùng khí tượng đã hiện thực hóa trong 72 giờ đích theo mã công khai; trạng thái đầu vào tương lai của các đối chứng khác không được suy đoán khi chưa kiểm toán mã.}
  \label{tab:test-reference}
  \begin{threeparttable}
  \footnotesize
  \setlength{\tabcolsep}{3.4pt}
  \renewcommand{\arraystretch}{1.03}
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{2.55cm}>{\raggedright\arraybackslash}Xrrr@{}}
    \toprule
    Họ phương pháp & Mô hình & MAE & RMSE & sMAPE \\
    \midrule
    \multicolumn{5}{@{}l}{\textit{Khối A --- Các số do AirDDE tổng hợp hoặc chạy lại}} \\
    \addlinespace[1pt]
    \multirow{8}{2.55cm}{\raggedright Dự báo không gian--thời gian} & DCRNN (2018)$^{\dagger}$ & 24.02 & 37.87 & 0.53 \\
    & STGCN (2018)$^{\dagger}$  & 23.64 & 32.48 & 0.52 \\
    & ASTGCN (2019)$^{\dagger}$ & 19.92 & 31.39 & 0.44 \\
    & MTGNN (2020)  & 18.92 & 30.34 & 0.41 \\
    & Crossformer (2023) & 21.11 & 32.97 & 0.44 \\
    & PDFormer (2023)  & 19.06 & 30.66 & 0.41 \\
    & iTransformer (2024) & 21.03 & 33.14 & 0.46 \\
    & STMFormer (2025)  & 19.57 & 31.12 & 0.44 \\
    \addlinespace[2pt]
    \multirow{5}{2.55cm}{\raggedright Chuyên cho chất lượng không khí} & PM2.5-GNN (2020)$^{\dagger}$  & 19.32 & 30.12 & 0.43 \\
    & GAGNN (2023)  & 20.71 & 32.88 & 0.42 \\
    & AirFormer (2023)$^{\dagger}$  & 19.17 & 30.19 & 0.43 \\
    & MegaCRN (2023) & 18.77 & 29.45 & 0.42 \\
    & HimNet (2024)  & 20.98 & 33.00 & 0.44 \\
    \addlinespace[2pt]
    \multirow{6}{2.55cm}{\raggedright Động lực nơ-ron / định hướng vật lý} & STGODE (2021) & 21.40 & 33.47 & 0.45 \\
    & STG-NCDE (2022) & 21.21 & 33.80 & 0.45 \\
    & STDDE (2024)  & 22.85 & 34.26 & 0.46 \\
    & SGODE (2024)  & 20.02 & 32.03 & 0.42 \\
    & AirPhyNet (2024)$^{\dagger}$ & 21.31 & 31.77 & 0.47 \\
    & Air-DualODE (2025)$^{\dagger}$ & 18.64 & 29.37 & 0.42 \\
    \addlinespace[2pt]
    \rowcolor{tsblue!6}
    Tham chiếu cùng tập thông tin & \textbf{AirDDE (2026)}  & \textbf{16.92} & \textbf{27.78} & \textbf{0.38} \\
    \midrule
    \multicolumn{5}{@{}l}{\textit{Khối B --- Kết quả của nghiên cứu này dưới cùng tập thông tin với AirDDE}} \\
    \addlinespace[1pt]
    \multirow{2}{2.55cm}{\raggedright Thiết lập chẩn đoán đề xuất} & \modelname{}, trung bình ba mô hình đơn  & $16.1266\pm0.0348$ & --- & --- \\
    & \modelname{}, trung bình đều ba mô hình & 15.8205 & 24.3253 & 0.3721 \\
    \bottomrule
  \end{tabularx}
  \begin{tablenotes}[flushleft]\footnotesize
    ...
    \item Cách phân nhóm theo họ do nghiên cứu này tổ chức để trình bày; PDFormer được xếp vào nhóm dự báo không gian--thời gian tổng quát. Mã AirDDE tại commit \texttt{9277a56} tách khí tượng của cửa sổ đích thành \texttt{y\_cov} và truyền nó vào hạng nguồn/mất mát cùng decoder, dù công thức trong bài chỉ ghi $M_{1:T}$. So sánh 4,7\% dùng trung bình ba mô hình đơn, không dùng ensemble.
  \end{tablenotes}
  \end{threeparttable}
\end{table}
...
\textbf{Quan sát 2:} các biến thể chỉ dùng lịch sử dừng quanh $20.5$--$20.9$ MAE. \textbf{Suy luận:} hướng tiếp theo nên tập trung vào trường khí tượng dự báo thực tế và truyền bất định ngoại sinh vào quỹ đạo \pmfine{}, thay vì tiếp tục tăng bộ nhớ xác định.

\textbf{Quan sát 3:} trên Beijing, \modelname{} giảm MAE và sMAPE nhưng làm tăng RMSE; khoảng tin cậy theo khối của MAE vẫn cắt 0. \textbf{Suy luận:} lợi ích ở sai số điển hình lặp lại ngoài KnowAir, còn các sai số lớn cần được xử lý tốt hơn trước khi khái quát hóa sang những mạng trạm khác.
...
Phân rã này cung cấp một thiên kiến cấu trúc rõ ràng, còn bằng chứng thực nghiệm trung tâm của nghiên cứu nằm ở so sánh với mô hình sinh trực tiếp gần bằng dung lượng. Đối chứng Beijing bổ sung một phép thử chuyển miền cho cùng kiến trúc \modelname{}.
...
\begin{enumerate}
  ...
  \item \textbf{So sánh AirDDE chỉ có điểm tổng hợp.} Kiểm toán mã xác nhận AirDDE và \modelname{} có cùng tập thông tin cùng giao thức dữ liệu KnowAir cốt lõi, nên chênh lệch MAE điểm $16.92$ so với $16.1266$ là so sánh đầu vào công bằng. Tuy nhiên, AirDDE không phát hành dự báo theo cửa sổ, độ biến thiên qua hạt giống hay checkpoint gắn với số công bố; vì vậy không thể lập khoảng tin cậy ghép cặp hoặc kết luận ưu thế thống kê. Việc bài AirDDE viết công thức chỉ dùng lịch sử trong khi mã đọc khí tượng đích cũng làm giảm độ minh bạch của giao thức \citep{wu2026airdde}.
  ...
  \item \textbf{Bất định thống kê.} Phương pháp lấy mẫu lại theo khối đã xử lý phụ thuộc thời gian cho cặp trực tiếp/\modelname{} trên Beijing. Chuỗi dự báo của đối chứng trực tiếp khớp dung lượng trên KnowAir không được giữ cùng điểm kiểm tra, nên chênh lệch trung tâm $2.0990$ được báo qua ba hạt giống nhưng chưa có khoảng tin cậy ghép cặp theo thời gian.
\end{enumerate}

\section{Khả năng tái lập}

Mã nguồn lưu toàn bộ phép biến đổi dữ liệu, kiến trúc, hàm mất mát và lệnh huấn luyện. Thí nghiệm được chạy với hạt giống 42, 43 và 44; mỗi cấu hình có điểm kiểm tra riêng. Gói bài báo lưu bảng số liệu nguồn ở định dạng JSON và mã băm SHA-256 của ba điểm kiểm tra lõi. Đối với Beijing, tệp giao thức ghi mã băm của 12 tệp nguồn, quy tắc xử lý thiếu và phép chia tập; một tệp riêng lưu mã băm điểm kiểm tra cùng quy tắc diễn giải trước lần đánh giá cuối. Bảng~\ref{tab:hyperparameters} ở Phụ lục ghi các siêu tham số cần thiết để tái lập.

Để tránh rò rỉ theo thời gian, chuẩn hóa chỉ khớp trên phần huấn luyện; cửa sổ lịch sử và đích nằm trọn trong từng phân đoạn; điểm kiểm tra mô hình được chọn bằng MAE xác thực. Kết quả kiểm tra \modelname{} dùng \texttt{scripts/evaluate\_tsr\_primary.py}; đối chứng ngoài dùng \texttt{scripts/prepare\_beijing\_multisite.py} và \texttt{scripts/evaluate\_external\_pair.py}. Mã AirDDE công khai được kiểm toán từ \url{https://github.com/w2obin/airdde-aaai} tại commit \texttt{9277a56db4bcc0e5e6a3a78bc9aa2b8df09d9774}; kết luận về khí tượng đích dựa trên đường dữ liệu và lời gọi mô hình ở phiên bản này. Ma trận KnowAir tham chiếu chạy với Python 3.11, PyTorch 2.8.0 và CUDA 12.8; thí nghiệm Beijing chạy với Python 3.11, PyTorch 2.13.0 và MPS. Kiến trúc được chọn trên tập xác thực; do tập kiểm tra KnowAir đã từng được xem trong quá trình phát triển dự án, các số kiểm tra được trình bày như đánh giá cuối của cấu hình đã chọn, không dùng để tinh chỉnh thêm. Kho ẩn danh cùng định danh phiên bản lưu trữ sẽ được bổ sung trước khi nộp.

\section{Kết luận}

Nghiên cứu cho thấy dự báo \pmfine{} 72 giờ có điều kiện trên khí tượng đích được hưởng lợi khi được viết như một quá trình tiến hóa trạng thái thay vì sinh toàn bộ chân trời trực tiếp từ một biểu diễn lịch sử cố định. Bằng chứng trung tâm là đối chứng trực tiếp gần bằng dung lượng và dùng cùng tập thông tin: MAE xác thực KnowAir giảm từ $18.8620$ xuống $16.7630$. Trên Beijing độc lập, lợi ích lặp lại ở MAE và sMAPE nhưng không ở RMSE, qua đó xác định rõ hướng cần cải thiện đối với các sai số cực trị. Khoảng cách lớn của các biến thể chỉ dùng lịch sử đặt ưu tiên tiếp theo vào khí tượng dự báo thực tế và lan truyền bất định ngoại sinh.
...
\begin{table}[h]
  \centering
  \caption{Siêu tham số của \modelname{} và đối chứng trực tiếp.}
